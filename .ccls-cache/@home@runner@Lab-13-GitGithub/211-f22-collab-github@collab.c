...
void maguir23_veskan2(){
  printf("Mario Aguirre-Rosales and Veronica Eskandar\n");
  printf("We learned that git and GitHub let you view and manage your code history\n");
}
